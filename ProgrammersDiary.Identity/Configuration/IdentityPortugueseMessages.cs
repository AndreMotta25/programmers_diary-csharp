...
namespace ProgrammersDiary.Identity.Configuration
{
    public class IdentityPortugueseMessages:IdentityErrorDescriber
    {
        ...
        public override IdentityError DuplicateUserName(string userName) { return new IdentityError { Code = nameof(DuplicateUserName), Description = $"Usuário '{userName}' já está sendo utilizado." }; }
